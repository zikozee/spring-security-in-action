package com.zikozee.smallwebapp;

import com.zikozee.smallwebapp.entity.Authority;
...
public class SmallWebAppApplicationTests {
    ...
    public void testAuthenticationWithValidUser() throws Exception {
        ...
        when(userRepository.getUserByUsername("mary"))
